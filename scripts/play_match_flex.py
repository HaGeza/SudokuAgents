...
from simulate_game_flex import play_game as play_game_flex
...
def play_match(player: str, opponent: str, count: int, board_file: str, calculation_time: float, verbose=False) -> None:
    player_score = 0.0
    opponent_score = 0.0
    result_lines = []
    ...
    for i in range(1, count+1):
        ...
        result = play_game_flex(board_file, first, second, calculation_time, verbose)
